...
Foundation milestone: project toolchain, app shell, themes, domain models, and the `localStorage` repository contract are in place. Editor, dashboard management, and import/export land in later milestones.
